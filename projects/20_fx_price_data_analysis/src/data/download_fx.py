 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "end_date = \"2025-01-01\"\n",
    "\n",
    "brl_df = yf.download(\"USDBRL=X\", start = start_date, end = end_date)\n",
    "egp_df = yf.download(\"USDEGP=X\", start = start_date, end = end_date)\n",
    "try_df = yf.download(\"USDTRY=X\", start = start_date, end = end_date)\n",
    "\n",
    "brl_df"
   ]
  },
